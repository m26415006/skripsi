...
public class Model_adminlive {
    String id,nama1,nama2,set_score,set_score1,set_score2,score1,score2;

    public Model_adminlive() {
    }

    public Model_adminlive(String id, String nama1, String nama2, String set_score, String set_score1, String set_score2, String score1, String score2) {
        this.id = id;
        this.nama1 = nama1;
        this.nama2 = nama2;
